...
class EventListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'location', 'starting_price', 'marketplace_max_price', 'revenue', 'commission', 'commission_rate',
...
class EventDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ticket_transfer_enabled', 'marketplace_max_price', 'tickets_sold', 'tickets_available',
...
class EventCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'total_tickets', 'ticket_limit', 'is_ticket_limit_unlimited',
            'ticket_transfer_enabled', 'marketplace_max_price', 'transfer_fee_type', 'transfer_fee_value',
